  ...
  return (
    <div className="flex items-center  justify-center ">
      ...
      <header className="flex justify-between items-center py-4 text-white">
        ...
        <Link to='/' className="text-gray-300 text-sm hover:text-gray-500">Go Home</Link>
      </header>
      <Formik
        initialValues={post}
      ...
      >
        ...
        {({ handleSubmit }) => (
          <Form onSubmit={handleSubmit}>
            <label htmlFor="title" className="text-sm block text-gray-400">Title</label>
            <Field
              name="title"
              placeholder="title"
            ...
            <ErrorMessage
              ...
              name="title"
            />
            <label htmlFor="description" className="text-sm block text-gray-400">Description</label>
            <Field
              component="textarea"
              rows="5"
              name="description"
            ...
            <ErrorMessage
              ...
              name="description"
            />
            <label htmlFor="title" className="text-sm block text-gray-400">Image</label>
            <input type="file" name="image" id="" className="px-3 py-y focus:outline-none rounder border-gray-600"/>

            <button type="submit" className="text-white bg-indigo-600 hover:bg-indigo-500 px-4 py-2 rounded mt-2 focus-outline-none disabled:bg-indigo-400 w-full">
              Save
            </button>
          </Form>
        )}
